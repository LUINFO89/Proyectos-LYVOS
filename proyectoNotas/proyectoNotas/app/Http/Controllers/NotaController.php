...
class NotaController extends Controller
{
    ...
    public function create()
    {
        ...
        $estudiante= Estudiante::pluck('nombre', 'id');

        return view('nota.create', compact('nota','cursos','estudiante'));
    }
    ...
    public function edit($id)
    {
        ...
        $cursos= Curso::pluck('nombre', 'id');
        $estudiante= Estudiante::pluck('nombre', 'id');
        $notas= Nota::sum('nota')->grupBy('nota')->get();

        return view('nota.edit', compact('nota','cursos','estudiante','notas'));
    }
