...
class FacturaController extends Controller
{
    ...
    {
        $factura = new Factura();
        $solicitud = Solicitude::pluck('id', 'id');
        $cliente = Cliente::pluck('id', 'id');
        $clienteiden = Cliente::pluck('identificacion', 'id');


        return view('factura.create', compact('factura', 'solicitud', 'cliente', 'clienteiden'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('factura.edit', compact('factura', 'solicitud', 'cliente', 'clienteiden'));
    }
