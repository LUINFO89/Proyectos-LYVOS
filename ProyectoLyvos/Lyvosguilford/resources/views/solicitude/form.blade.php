<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            {{ Form::label('Descripción de la solicitud') }}
            {{ Form::textarea('nombreSolicitud', $solicitude->nombreSolicitud, ['class' => 'form-control' . ($errors->has('nombreSolicitud') ? ' is-invalid' : ''), 'placeholder' => 'Describe la solicitud']) }}
            {!! $errors->first('nombreSolicitud', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
            {{ Form::label('fecha') }}

            {{ Form::date('fecha', $solicitude->fecha, ['class' => 'form-control' . ($errors->has('fecha') ? ' is-invalid' : ''), 'placeholder' => 'Año- Mes - Dia']) }}
