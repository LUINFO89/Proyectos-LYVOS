<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            {{ Form::label('quantity_left') }}
            {{ Form::text('quantity_left', $product->quantity_left, ['class' => 'form-control' . ($errors->has('quantity_left') ? ' is-invalid' : ''), 'placeholder' => 'Quantity Left']) }}
            {!! $errors->first('quantity_left', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
